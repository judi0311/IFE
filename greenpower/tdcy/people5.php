...
<div id="container">
	...
	require_once '../inc/condata.php';?>
     <?php  $id=$_GET[id];
	$query = mysql_query("select * from yjs_people where type=5 ");
...
<li>
 <?php 
		...
		<h3><strong>姓&nbsp&nbsp名</strong>&nbsp&nbsp<?php echo "<a href=peopleshow.php?id=";
				echo $id[$i];
				echo ">";
				echo $name[$i];
				echo "</a>";
		...
		<?php
		  ...
		  ?> </h3>
        <h3><strong>身&nbsp&nbsp份&nbsp&nbsp </strong> <?php echo 已毕业学生?> </h3> 
				...
				<div class="boxnav">
					...
					<div class="boxnavcontent">
						<ul class="menunav">
							...
							<li class="last"><a href="people5.php">已毕业学生</a></li>
						</ul>
					</div>
				</div>
