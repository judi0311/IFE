...
<?php include("../../inc/header1.php");?>
		...
		<ul>
						<li><img src="../../images/14.jpg" alt="Images" width="400" height="300" class="imgleft" />
							<p>Lorem ipsum dolor sit4amet, consectetur adipiscing elit. Donec placerat, mi eu posuere facilisis, dolor sapien auctor orci, vel posuere velit nibh ac tortor. Donec nunc orci, interdum vel iaculis nec, tincidunt sed diam. Nunc a arcu erat. Integer sed odio tellus, a porta purus. <strong>Proin eu metus nulla, a aliquet ante</strong>.</p>
						</li>
