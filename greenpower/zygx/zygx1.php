...
<?php include("../inc/header.php");?>
  ...
  <table width="550" border="0" align="center" cellpadding="1" cellspacing="2">
              <tr>
                <td width="550" align="right" valign="top"> 
                  <?php
				     ...
				     $sql = "select * from yjs_files where filetype='1' order by filetime desc";
                  ...
                  <?php }else{
				        ...
				        $firstline = ($page - 1) * $pagesize;               
				  	    ...
				  	    $sql = "select * from yjs_files where filetype='1' order by filetime desc limit ".$firstline.",".$lastline;
				        $result=mysql_query($sql,$db);
				   ?>
	          ...
	          echo "<li> <span >$rows[filetime]</span><a href=showfiles.php?id=$rows[autoid] target='_blank'>$rows[filename]</a> </li>";}
	                  ?>	
                    ...
                    <tr > 
                      <td ><ul id="listpages"><?php
						...
						echo" 页</li>";
                        if ($page > 1)
                            echo " <li><a href=\"zygx1.php?page=".intval($page-1)."\" class=\"font3\">上一页</a></li> ";
							
                        if ($page <> $pages)
                      	  echo " <li><a href='zygx1.php?page=".intval($page+1)."' class=\"font3\">下一页</li></a> ";
						  
                      	echo " <li class=dotted>转到页</li>";
                        echo "<li class=active ><select onChange='MM_jumpMenu(this,0)' class=\"link1\">";
                        echo "<option>请选择</option>";
                        for ($i=1;$i<=$pages;$i++) {
                             echo "<option value='zygx1.php?page=$i'>$i</option>";
                             }
                        echo "</li></select>";
						?></ul></td>
                        </tr>
		  ...
		  <div id="nav">
				...
				<div class="boxnav">
					<h3 class="titlenav">资源共享</h3>
					<div class="boxnavcontent">
						<ul class="menunav">
							<li><a href="zygx1.php">常用网站</a></li>
							<li><a href="zygx2.php">科研网站</a></li>
							<li><a href="zygx3.php">知名期刊网站</a></li>
							<li class="last"><a href="zygx4.php">知名课题组</a></li>
						</ul>
					</div>
              </div>
