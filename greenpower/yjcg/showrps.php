...
<ul id="listnews">
	...
	<li><h2><a href="#"><?php 
               ...
               <ul class="listinfo">
                                ...
                                <?php  if($rows[rpsimage] != ""){ 
				$imgfile = "../download/" . $rows[rpsimage];
				@$isize = GetImageSize($imgfile);
                echo "<img src=\"".$imgfile."\" width=$isize[0] height=$isize[1] hspace=\"13\" vspace=\"4\" align=\"left\">";
			 } 
			 $rpstext = str_replace(chr(13),"<br>",$rows[rpstext]);
			 $rpstext = str_replace(" ","&nbsp;",$rpstext);
			
			 ?>
			<p class="posted"><?php echo $rpstext;?></p>
								<p>  <?php
			 echo "<span class=\"font1\"> ";
             echo "<br><img src=\"../images/icon_comment.png\" width=\"16\" align=\"absmiddle\">相关附件:</span><br>";
			 if($rows[rpfj1] != ""){
			    $rowsrpfj = explode("*",$rows[rpfj1]);
			    echo "<a href='../download/".$rowsrpfj[0]."' class=\"font1\" target='_blank'>".$rowsrpfj[1]."</a><br>";
			 }
			 if($rows[rpfj2] != ""){
			    $rowsrpfj = explode("*",$rows[rpfj2]);
			    echo "<a href='../download/".$rowsrpfj[0]."' class=\"font1\" target='_blank'>".$rowsrpfj[1]."</a><br>";
			 }
			 if($rows[rpfj3] != ""){
			    $rowsrpfj = explode("*",$rows[rpfj3]);
			    echo "<a href='../download/".$rowsrpfj[0]."' class=\"font1\" target='_blank'>".$rowsrpfj[1]."</a><br>";
			 }
		   ?></p>
   </li>
