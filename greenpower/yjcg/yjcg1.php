...
<?php include("../inc/header.php");?>
  ...
  <table width="550" border="0" align="center" cellpadding="1" cellspacing="2">
              <tr>
                <td width="550" align="right" valign="top"> 
                  <?php
				     ...
				     $sql = "select * from yjs_rps where rptype='1' order by rptime desc";
                  ...
                  <?php }else{
				        ...
				        $firstline = ($page - 1) * $pagesize;               
				  	    ...
				  	    $sql = "select * from yjs_rps where rptype='1' order by rptime desc limit ".$firstline.",".$lastline;
				        $result=mysql_query($sql,$db);
				   ?>
	          ...
	          echo "<li> <span >$rows[rptime]</span><a href=showrps.php?id=$rows[autoid] target='_blank'>$rows[rpname]</a> </li>";}
	                  ?>	
                    ...
                    <tr > 
                      <td ><ul id="listpages"><?php
						...
						echo" 页</li>";
                        if ($page > 1)
                            echo " <li><a href=\"yjcg1.php?page=".intval($page-1)."\" class=\"font3\">上一页</a></li> ";
							
                        if ($page <> $pages)
                      	  echo " <li><a href='yjcg1.php?page=".intval($page+1)."' class=\"font3\">下一页</li></a> ";
						  
                      	echo " <li class=dotted>转到页</li>";
                        echo "<li class=active ><select onChange='MM_jumpMenu(this,0)' class=\"link1\">";
                        echo "<option>请选择</option>";
                        for ($i=1;$i<=$pages;$i++) {
                             echo "<option value='jycg1.php?page=$i'>$i</option>";
                             }
                        echo "</li></select>";
						?></ul></td>
                        </tr>
		  ...
		  <div id="nav">
				...
				<div class="boxnav">
					...
					<div class="boxnavcontent">
						<ul class="menunav">
							<li><a href="yjcg1.php">文章</a></li>
							<li><a href="yjcg2.php">专利</a></li>
							<li><a href="yjcg3.php">项目</a></li>
						    <li><a href="yjcg4.php">获奖与荣誉</a></li>
							<li class="last"><a href="yjcg5.php">自主研发设备</a></li>
						</ul>
					</div>
				</div>
		  </div>
