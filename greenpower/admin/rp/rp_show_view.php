...
function chkinput(form)
	...
	<form name="form" enctype="multipart/form-data" method="post" action="rp_show_view_save.php"  onSubmit="return chkinput(this)">
	  ...
	  <?php
				     ...
				     $sql = "select * from yjs_rps where autoid='$_GET[id]'";
	  ...
	  <tr>
        ...
        <td width="658" ><div align="left"><select name="rptype"  >
      ...
      <tr>
        ...
        <td  ><div align="left">
          <input name="rptime" type="text" value="<?php echo date("Y-m-d"); ?>" size="18">
        </div></td>
      </tr>
      <tr>
        <td  ><div align="center">题目：</div></td>
        <td  ><div align="left">
        <input name="rpname" type="text" value="<?php echo $rows[rpname]; ?>" size="60">  
</div></td>
      </tr>
      ...
      <tr>
        ...
        <td><div align="left">
		 <input name="rpstext" type="text" value="<?php echo $rows[rpstext]; ?>" size="60">  
        </div></td>
      </tr>
