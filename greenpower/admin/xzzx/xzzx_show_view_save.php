...
<h2> 修改成功</h2>
 <?php
				     ...
				     $sql = "select * from yjs_files  where autoid='$_POST[id]'";
                  ...
                  <?php }
				           ...
				           { $sql = "update yjs_files  set filename='$_POST[filename]',filetype='$_POST[filetype]', filestext='$_POST[filestext]',filetime='$_POST[filetime]' where autoid='$_POST[id]'";
							mysql_query($sql,$db);
							mysql_close($db);
