  ...
  <A href="../../index.php"  target=_parent><B>返回首页</B></A>| <a href="../login.php" target=_parent><B>安全退出
	  ...
	  <TABLE cellSpacing=0 cellPadding=0 width=158 align=center>
        ...
        <TR>
          ...
          onmouseout="this.className='menu_title';" 
          background=style/images/admin_left_2.gif height=25><SPAN>学生会成员管理</SPAN> 
          </TD>
        </TR>
        <TR>
          <TD id=submenu1>
            ...
            <TABLE cellSpacing=0 cellPadding=0 width=135 align=center>
              ...
              <TR>
                <TD height=20><a href="yjhy/gz.php" target="mainFrame"> 研究生会成员添加 </a></TD>
              </TR>
              <TR>
                <TD height=20><a href="yjhy/gzshow.php" target="mainFrame"> 研究生会信息修改 </a></TD>
              </TR>
              </TBODY></TABLE>
            </DIV>
            <DIV style="WIDTH: 158px">
	  ...
	  <TABLE cellSpacing=0 cellPadding=0 width=158 align=center>
        ...
        <TR>
          ...
          onmouseout="this.className='menu_title';" 
          background=style/images/admin_left_9.gif 
        ...
        <TR>
          <TD>
            ...
            <TABLE cellSpacing=0 cellPadding=0 width=135 align=center>
              <TBODY>
              <TR>
                <TD height=20 bgcolor="#D6DFF7" style="LINE-HEIGHT: 150%">版权:吉大通信学院
